         ...
         <p style={{ fontSize:"3vw",color:"black",width:"16vw",margin: "0 auto",marginTop:"20px",}}><u>Contact Us</u></p>
          ...
          <div style={{overflow: "hidden"}}>
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <td><input style={{boxShadow:"1px 1px 1px black"}} required type="text" placeholder="Enter Name" id="name" name="user_name"></input></td>
              </tr><br/><br/>
              <tr>
              <td><label style={{fontSize:"1.5vw"}}>Mobile : <br/></label></td>
              <td><input style={{boxShadow:"1px 1px 1px black"}} required type="number" placeholder="Enter Mobile" id="mob" name="user_mobile"></input></td>
              </tr><br/><br/>
              <tr>
              <td><label style={{fontSize:"1.5vw"}}>Email : </label></td>
              <td><input style={{boxShadow:"1px 1px 1px black"}} required type="email" placeholder="Enter Mail" id="mail" name="user_email"></input></td>
              </tr><br/><br/>
              <tr>
              <td><label style={{fontSize:"1.5vw"}}>Message : <br/></label></td>
              <td><textarea style={{boxShadow:"1px 1px 1px black", resize:"none"}} required name="message" rows="5" cols="30" id="msg" placeholder="Enter Your Message Here" ></textarea></td>
              </tr><br/>
              </table>
